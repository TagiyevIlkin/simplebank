...
// Source: github.com/TagiyevIlkin/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TrasferTxParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
